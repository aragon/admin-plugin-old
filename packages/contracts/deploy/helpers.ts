...
export async function isENSDomainRegistered(
  ...
  const ensRegistryContract = ENS__factory.connect(ensRegistryAddress, signer);
...
export async function registerSubnodeRecord(
  ...
  const ensRegistryContract = ENS__factory.connect(ensRegistryAddress, owner);
...
export async function transferSubnodeRecord(
  ...
  const ensRegistryContract = ENS__factory.connect(
    ensRegistryAddress,
    deployer
  );
